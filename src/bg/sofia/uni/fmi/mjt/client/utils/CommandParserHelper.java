...
import static bg.sofia.uni.fmi.mjt.client.constants.CommandConstants.PARAMS_SPLIT_REGEX;
...
public final class CommandParserHelper {
    ...
    public static BarcodeRequestDto parseBarcodeCommand(String[] params) throws InvalidCommandException {
        String code = null;
        ...
        for (String token : params) {
            ...
            int eqIndex = token.indexOf(PARAMS_SPLIT_REGEX);
        ...
        return new BarcodeRequestDto(code, imagePath);
    }
